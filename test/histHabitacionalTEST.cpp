...
TEST(histHabitacionalTEST, hist100) {

//                                          Región  #Habitaciones
//                                            v      v
    eph_h th = {{22010,2020,3,319938,629513,1,41,0,1,5,2,2},
                {20101,2020,3,315773,625696,1,41,0,1,2,2,2},
                {20102,2020,3,315773,625696,1,40,0,1,2,2,2}};

    eph_i ti = {{22010,2020,1,0,3,1,65,1,2,15000,8},
                {22010,2020,2,0,3,2,22,0,0,10000,10},
                {22010,2020,3,0,3,1,9,0,0,0,10},
